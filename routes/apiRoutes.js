...
router.get('/dailyentry/existing/:entryId', checkJwt, entriesController.getExistingEntry);
...
router.post('/dailyentry/:entryId', checkJwt, entriesController.updateDailyEntryScore);
